...
import type { ModelUsage, ResponseInput, ResponseInputItem, Agent as AgentType } from '@just-every/ensemble';
...
export async function runMECH(agent: AgentType, content: string): Promise<MechResult> {
    try {
