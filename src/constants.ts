...
export const DESIGN_SEARCH_DESCRIPTIONS: string[] = [
    '- brave_images: extremely effective image search with diverse results—good for finding visual references across the web',
    ...
    '- unsplash: high-quality free stock photography with professional aesthetic—excellent for modern, clean visual references and inspiration',
    ...
    '- freepik: extensive collection of illustrations, and design resources—ideal for diverse graphic design inspirations',
    '- vecteezy: graphics and illustrations marketplace—excellent for scalable logo designs and vector-based graphics',
